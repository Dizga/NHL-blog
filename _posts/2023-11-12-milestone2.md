...
Cette figure montre la performance des quelques combinaisons affirmant que la meilleure combinaison est 
 {"scale_pos_weight":1.5, "eta":0.1, "n_estimators":400, "max_depth":4} 
![](/assets/images/combinaison.png)

Par la suite, nous avons entraîné notre modèle en utilisant la meilleure combinaison d'hyperparamètres identifiée, et les résultats obtenus sont représentés dans la figure ci-dessous.
